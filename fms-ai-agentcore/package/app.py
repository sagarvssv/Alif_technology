...
def generate_complete_audit_planning_output(
    ...
    engagement_strategy = generate_section(
        invoke_claude,
        "Engagement Strategy",
        """
...
""",
    ...
    planning_memorandum = generate_section(
        invoke_claude,
        "Planning Memorandum",
        """
...
""",
    ...
    risk_assessment = generate_section(
        invoke_claude,
        "Risk Assessment",
        """
Include this table:
...
""",
    ...
    audit_programs = generate_section(
        invoke_claude,
        "Audit Programs",
        """
